...
class FortuneManager:
    ...
    def __init__(self):
        self._user_data: dict[str, dict[str, dict[str, str | bool]]] = dict()
    ...
    def _multi_divine_check(self, gid: str, uid: str) -> bool:
        ...
        return bool(self._user_data[gid][uid]["is_divined"])
    ...
    def divine(self, gid: str, uid: str, nickname: str, _theme: Optional[str] = None, spec_path: Optional[str] = None) -> tuple[bool, Path]:
        '''
            今日运势抽签，主题已确认合法
        '''
